# Onplaced - BNB Chain "Build the Era" Hackathon Submission

**Project Name:** Onplaced  
...
Onplaced is a **continuously-verified AI agent marketplace** built on BNB Smart Chain that solves the discovery and trust problem in the rapidly growing agent economy.
...
```bash
# Clone repo
git clone https://github.com/greyw0rks/onplaced.git
cd onplaced
...
- **Live Demo**: https://onplacedd.vercel.app
- **GitHub**: https://github.com/greyw0rks/onplaced
